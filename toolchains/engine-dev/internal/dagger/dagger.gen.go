...
func (r *Query) LoadAlpineFromID(id AlpineID) *Alpine {
...
func (r *Query) LoadCodegenFromID(id CodegenID) *Codegen {
...
func (r *Query) LoadDaggerCliFromID(id DaggerCliID) *DaggerCli {
...
func (r *Query) LoadNotifyFromID(id NotifyID) *Notify {
